...
class ManifestCommands(manifest: ManifestFacade) {
   ...
   */
  def manifestGetOptions(): js.Dictionary[js.Any] =
    manifest.manifestInternal("option").asInstanceOf[js.Dictionary[js.Any]]
   ...
   */
  def manifestSetOption(
    name: String,
    value: js.Any
  ) = manifest.manifestInternal("option", name, value)
...
class ManifestOptionBuilder(val dict: OptMap)
  extends JSOptionBuilder[ManifestOptions, ManifestOptionBuilder](new ManifestOptionBuilder(_)) {
  ...
  def formatValue(v: js.ThisFunction4[JQuery, js.Object, JQuery, JQuery, UndefOr[JQuery], String]) =
    jsOpt("formatValue", v)
}
