...
object RunButton {
   ...
   */
  def apply(kind:ButtonGadget.ButtonKind, inactiveLabel:String, activeLabel:String, mods:Modifier*)(onClick:RunButton => Unit)(implicit ecology:Ecology, ctx:Ctx.Owner) =
