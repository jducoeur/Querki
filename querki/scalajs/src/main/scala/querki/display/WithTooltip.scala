 ...
 * refactored first.
 */
class WithTooltip[Output <: dom.Element](tag:scalatags.JsDom.TypedTag[Output], tooltip:String = "")(implicit val ecology:Ecology) extends Gadget[Output] with EcologyMember  {
