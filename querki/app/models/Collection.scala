...
// TEMP: these are needed to keep NameCollection functioning for the moment:
import play.api.data.Form
private[models] abstract class SystemCollection(cid:OID, pf:PropFetcher)(implicit e:Ecology = querki.ecology.theEcology) extends Collection(cid, systemOID, querki.core.MOIDs.UrCollectionOID, pf)(e)
private[models] abstract class SingleElementBase(cid:OID, pf:PropFetcher) extends SystemCollection(cid, pf)
{
