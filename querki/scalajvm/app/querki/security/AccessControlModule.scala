...
class AccessControlModule(e: Ecology)
      ...
      hasPermissionProfile.profile {
        if (isManager(identityId, state) || identityId == querki.identity.MOIDs.SystemIdentityOID)
          ...
          val isCreator =
            ...
            } yield (creatorIdentityId == identityId)).getOrElse(false)
  ...
  def allPermissions(state: SpaceState): Iterable[Property[OID, _]] = {
    implicit val s = state
    state.allProps.map(_._2).filter(_.ifSet(isPermissionProp)).map(_.confirmType(LinkType).get)
  }
  ...
  lazy val SecurityPrincipal = ThingState(
    querki.identity.MOIDs.SecurityPrincipalOID,
    systemOID,
    RootOID,
    toProps(
  ...
  lazy val PersonModel = ThingState(
    querki.identity.MOIDs.PersonOID,
    systemOID,
    querki.identity.MOIDs.SecurityPrincipalOID,
    toProps(
      setName("Person"),
  ...
  lazy val MembersTag = ThingState(
    MembersTagOID,
    systemOID,
    SecurityPrincipal,
    toProps(
  ...
  lazy val InstancePermissionsModel = ThingState(
    InstancePermissionsModelOID,
    systemOID,
    RootOID,
    toProps(
  ...
  lazy val AppliesToSpace =
    ThingState(AppliesToSpaceOID, systemOID, RootOID, toProps(setName(commonName(_.security.appliesToSpace))))

  lazy val AppliesToModels =
    ThingState(AppliesToModelsOID, systemOID, RootOID, toProps(setName(commonName(_.security.appliesToModels))))

  lazy val AppliesToInstances =
    ThingState(AppliesToInstancesOID, systemOID, RootOID, toProps(setName(commonName(_.security.appliesToInstances))))
  ...
  lazy val isPermissionProp = new SystemProperty(
    IsPermissionOID,
    YesNoType,
    ExactlyOne,
    toProps(
  ...
  lazy val IsInstancePermissionProp = new SystemProperty(
    IsInstancePermissionOID,
    YesNoType,
    ExactlyOne,
    toProps(
  ...
  lazy val CanEditCustomProp = new SystemProperty(
    CanEditCustomOID,
    QLType,
    Optional,
    toProps(
  ...
  lazy val CanEditProp = new SystemProperty(
    CanEditPropOID,
    LinkType,
    QSet,
    toProps(
      ...
      Details(
        """Note that this Property is *not* inherited, unlike most. If you want to
          |say who can edit Things made from this Model, use [[Who Can Edit Children._self]] instead.""".stripMargin
      )
    )
  )

  lazy val CanEditChildrenProp = new SystemProperty(
    CanEditChildrenPropOID,
    LinkType,
    QSet,
    toProps(
  ...
  lazy val CanCreateProp = definePermission(
    CanCreatePropOID,
  ...
  lazy val CanDesignPerm = definePermission(
    CanDesignPermOID,
  ...
  lazy val CanManageDataPerm = definePermission(
    CanManageDataPermOID,
  ...
  lazy val DefaultPermissionProp = new SystemProperty(
    DefaultPermissionPropOID,
    LinkType,
    QSet,
    toProps(
  ...
  lazy val PublicAllowedProp = new SystemProperty(
    PublicAllowedPropOID,
    YesNoType,
    Optional,
    toProps(
  ...
  lazy val RolePermissionsProp = new SystemProperty(
    RolePermissionsOID,
    LinkType,
    QSet,
    toProps(
  ...
  lazy val PersonRolesProp = new SystemProperty(
    PersonRolesOID,
    LinkType,
    QSet,
    toProps(
      ...
      Categories(SecurityTag),
      Summary(
        """This Property is only useful on Persons. It defines the Roles that this Person has.
          |You do not assign it directly; use the Sharing and Security page to manage which Roles each Person has.""".stripMargin
      )
    )
  )

  lazy val ChildPermissionsProp = new SystemProperty(
    ChildPermissionsPropOID,
    LinkType,
    Optional,
    toProps(
  ...
  lazy val InstancePermissionsProp = new SystemProperty(
    InstancePermissionsPropOID,
    LinkType,
    ExactlyOne,
    toProps(
  ...
  lazy val PermAppliesTo = new SystemProperty(
    PermAppliesToOID,
    LinkType,
    QSet,
    toProps(
  ...
  lazy val HasPermissionFunction = new InternalMethod(
    HasPermissionFunctionOID,
    toProps(
