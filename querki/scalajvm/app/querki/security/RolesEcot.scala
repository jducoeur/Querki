...
class RolesEcot(e: Ecology) extends QuerkiEcot(e) with Roles with querki.core.MethodDefs {
  ...
  lazy val HasRoleFunction = new InternalMethod(
    HasRoleOID,
    toProps(
      setName("_hasRole"),
  ...
  lazy val RoleMembersFunction = new InternalMethod(
    RoleMembersOID,
    toProps(
   ...
   * put it.
   */
  lazy val CanExplorePerm = AccessControl.definePermission(
    CanExplorePermOID,
  ...
  lazy val CanManageSecurityPerm = AccessControl.definePermission(
    CanManageSecurityPermOID,
  ...
  lazy val IsOpenInvitation = new SystemProperty(
    OpenInvitationOID,
    YesNoType,
    Optional,
    toProps(
  ...
  lazy val InviteRoleLink = new SystemProperty(
    InviteRoleLinkOID,
    LinkType,
    Optional,
    toProps(
  ...
  lazy val InviteRequiresMembership = new SystemProperty(
    InviteRequiresMembershipOID,
    YesNoType,
    Optional,
    toProps(
      ...
      setInternal,
      Summary(
        "When set on a Shared Invitation Link, that Link will force recipients to sign up, rather than being Guests."
      )
    )
  )
  ...
  def defineRole(
    ...
    display: String,
    desc: String,
    perms: Seq[Property[OID, OID]]
  ): ThingState = ThingState(
    id,
    systemOID,
    AccessControl.RoleModel,
    toProps(
      setName(name),
  ...
  lazy val CustomRoleModel = ThingState(
    CustomRoleModelOID,
    systemOID,
    AccessControl.RoleModel,
    toProps(
  ...
  lazy val SharedInviteModel = ThingState(
    SharedInviteModelOID,
    systemOID,
    RootOID,
    toProps(
      ...
      setInternal,
      Summary(
        "The Thing pointer to by a Shared Invite. Still good iff _isOpenInvitation is true. Not to be used directly."
      ),
      Core.IsModelProp(true),
