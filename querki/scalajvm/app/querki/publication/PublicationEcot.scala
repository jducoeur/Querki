...
class PublicationEcot(e: Ecology) extends QuerkiEcot(e) with querki.core.MethodDefs with Publication {
   ...
   */
  private case class StateEvolver(state: SpaceState)(implicit val ecology: Ecology)
    extends querki.spaces.SpacePure
    with EcologyMember {
    val id = state.id
  ...
  lazy val PublishEventType = new SystemType[OnePublishEvent](
    PublishEventTypeOID,
    toProps(
      setName("_publishEventType"),
      Categories(PublicationTag),
      Core.InternalProp(true),
      Summary("Represents a single Publish or Update event")
    )
  ) with SimplePTypeBuilder[OnePublishEvent] {
    ...
    def doWikify(
      ...
      Future.successful(
        Wikitext(s"* $when: [${thingInfo.displayName}](${thingInfo.thingId.toThingId.toString}) $eventKind")
      )
    }
  ...
  lazy val PublishedThingType = new SystemType[OnePublishedThing](
    PublishedThingTypeOID,
    toProps(
      ...
      Details("""While you usually Publish or Update a single Thing at a time, Querki is designed to
                ...
                |`_publishedThings` to get the list of Things involved, and that produces one of these.""".stripMargin)
    )
  ) with SimplePTypeBuilder[OnePublishedThing] {
    def doDeserialize(v: String)(implicit state: SpaceState) = ???
  ...
  lazy val PublishFunction = new InternalMethod(
    PublishFunctionOID,
    toProps(
      setName("_publish"),
      Categories(PublicationTag),
    ...
    override def qlApply(inv: Invocation): QFut = {
      ...
      for {
        ...
        _ <- inv.test(
          AccessControl.hasPermission(CanPublishPermission, spaceState, who, spaceState),
          "Publication.publishNotAllowed",
          Seq(thing.displayName)
        )
  ...
  lazy val GetChangesFunction = new InternalMethod(
    GetChangesOID,
    toProps(
      setName("_getChanges"),
      Categories(PublicationTag),
  ...
  lazy val PublishMinorUpdateFunction = new InternalMethod(
    PublishMinorUpdateOID,
    toProps(
  ...
  lazy val PublishedThingsFunction = new InternalMethod(
    PublishedThingsOID,
    toProps(
      ...
      Details(
        """These are of [[_publishedThingType]], and have their own functions to get information from them.""".stripMargin
      )
    )
  ) {
  ...
  lazy val PublishedUpdateFunction = new InternalMethod(
    PublishedUpdateOID,
    toProps(
      setName("_isAnUpdate"),
      Categories(PublicationTag),
      Summary(
        "This says whether a [[_publishedThingType]] is an Update (if true) or the first Publish for this Thing (if false)"
      )
    )
  ) {
  ...
  lazy val PublishedDisplayNameFunction = new InternalMethod(
    PublishedDisplayNameOID,
    toProps(
  ...
  lazy val PublishedViewFunction = new InternalMethod(
    PublishedViewOID,
    toProps(
  ...
  lazy val PublishedNotesFunction = new InternalMethod(
    PublishedNotesFunctionOID,
    toProps(
  ...
  lazy val PublishableModelProp = new SystemProperty(
    PublishableModelOID,
    YesNoType,
    ExactlyOne,
    toProps(
  ...
  lazy val MinorUpdateProp = new SystemProperty(
    MinorUpdateOID,
    YesNoType,
    ExactlyOne,
    toProps(
  ...
  lazy val PublishedProp = new SystemProperty(
    PublishedOID,
    YesNoType,
    ExactlyOne,
    toProps(
  ...
  lazy val HasUnpublishedChanges = new SystemProperty(
    UnpublishedChangesOID,
    YesNoType,
    ExactlyOne,
    toProps(
  ...
  lazy val PublishNotesProp = new SystemProperty(
    PublishNotesPropOID,
    LargeTextType,
    Optional,
    toProps(
  ...
  lazy val SpaceHasPublications = new SystemProperty(
    SpaceHasPublicationsOID,
    YesNoType,
    Optional,
    toProps(
  ...
  lazy val RecentChangesPage = ThingState(
    RecentChangesPageOID,
    systemOID,
    RootOID,
    toProps(
