...
import models.{DisplayPropVal, Kind, PType, PropertyBundle, SimplePTypeBuilder, ThingState, Wikitext}
...
class RatingEcot(e: Ecology)
  ...
  lazy val ReviewModel = ThingState(
    ReviewModelOID,
    systemOID,
    RootOID,
    toProps(
  ...
  lazy val RatingType: PType[Int] with SimplePTypeBuilder[Int] = new IntTypeBase(
    RatingTypeOID,
    toProps(
      setName("Rating Type"),
      Categories(UserValuesTag),
      Summary("Lets you rate Things with stars. Usually, you can just use the built-in [[Rating._self]] Property.")
    )
  ) with DiscreteType[Int] {
    ...
    override def renderInputXml(
      ...
      fut(if (prop.ifSet(RatingShowTargetProperty)) {
        ...
        <div class='_rating' data-rating={get(v).toString} data-labels={labels.mkString(",")} data-target={
          targetId
        } data-targetkeep='true'></div> :+
  ...
  lazy val ReviewType = new ModelType(
    ReviewTypeOID,
    ReviewModelOID,
    toProps(
      setName("Review Type"),
      Categories(UserValuesTag),
      Summary(
        "Lets you rate Things and provide opinions. Usually used through the built-in [[Review._self]] Property."
      ),
    ...
    override def doWikify(
      ...
      bundle: ModeledPropertyBundle,
      displayOpt: Option[Wikitext],
      lexicalThing: Option[PropertyBundle] = None
    ) = {
      implicit val state = context.state
   ...
   */
  lazy val RatingAverageType = new SystemType[RatingAverage](
    RatingAverageTypeOID,
    toProps(
      setName("_ratingAverageType"),
      Categories(UserValuesTag),
      setInternal
    )
  ) with SimplePTypeBuilder[RatingAverage] {
  ...
  lazy val RatingSummarizer = new DiscreteSummarizer(
    RatingSummarizerOID,
    RatingType,
    toProps(
      ...
      Categories(UserValuesTag),
      Summary(
        "Given a User Value Property made of numbers (such as Ratings), this provides functions such as _average."
      )
    )
  ) {

    override def wikifyKey(
      context: QLContext,
      fromProp: Option[Property[_, _]],
      key: Int
    ): Future[Wikitext] = {
      implicit val state = context.state
      fromProp match {
   ...
   */
  lazy val AverageFunction = new InternalMethod(
    AverageFunctionOID,
    toProps(
      setName("_average"),
      Categories(UserValuesTag),
  ...
  lazy val LabelsProp = new SystemProperty(
    LabelsPropOID,
    PlainTextType,
    QList,
    toProps(
  ...
  lazy val RatingSummaryProperty = new SystemProperty(
    RatingSummaryPropOID,
    RatingSummarizer,
    ExactlyOne,
    toProps(
  ...
  lazy val RatingProperty: Property[Int, Int] = new SystemProperty(
    RatingPropOID,
    RatingType,
    ExactlyOne,
    toProps(
  ...
  lazy val ReviewCommentsProperty = new SystemProperty(
    ReviewCommentsPropOID,
    LargeTextType,
    ExactlyOne,
    toProps(
  ...
  lazy val ReviewProperty = new SystemProperty(
    ReviewPropOID,
    ReviewType,
    ExactlyOne,
    toProps(
      ...
      Details(
        """If you put this Property on a Thing or Model, you can simply say
  ...
  lazy val RatingShowTargetProperty = new SystemProperty(
    RatingShowTargetOID,
    YesNoType,
    ExactlyOne,
    toProps(
