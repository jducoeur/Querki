...
class UserValueEcot(e: Ecology)
  ...
  override def persistentMessages = persist(44, (classOf[PersistentEvents.DHUserValue] -> 100))
   ...
   */
  lazy val SummarizerBase = ThingState(
    SummarizerBaseOID,
    systemOID,
    RootOID,
    toProps(
  ...
  lazy val UserValueModel = ThingState(
    UserValueModelOID,
    systemOID,
    RootOID,
    toProps(
  ...
  lazy val UserValueType = new ModelType(
    UserValueTypeOID,
    UserValueModelOID,
    toProps(
  ...
  lazy val UserValuesFunction = new InternalMethod(
    UserValuesFunctionOID,
    toProps(
      setName("_userValues"),
      Categories(UserValuesTag),
  ...
  lazy val ThingValuesFunction = new InternalMethod(
    ThingValuesFunctionOID,
    toProps(
  ...
  lazy val UpdatePropSummariesFunction = new InternalMethod(
    UpdatePropSummariesFunctionOID,
    toProps(
      ...
      Details(
        """This function is expensive, and should not be called unless you have reason to believe that
    ...
    override def qlApply(inv: Invocation): QFut = {
      ...
      for {
        ...
        recalcRequest = SpacePluginMsg(
          inv.context.request.requesterOrAnon,
          inv.state.id,
          RecalculateSummaries(prop, summaryPropId, values)
        )
  ...
  lazy val IsUserValueFlag = new SystemProperty(
    IsUserValueFlagOID,
    YesNoType,
    ExactlyOne,
    toProps(
      ...
      Categories(UserValuesTag),
      Summary(
        "Add this flag to a Property, and set it to true, if this Property should have a separate value for each user."
      )
    )
  )

  lazy val SummaryLink = new SystemProperty(
    SummaryLinkOID,
    LinkType,
    ExactlyOne,
    toProps(
  ...
  lazy val SummarizesPropertyLink = new SystemProperty(
    SummarizesPropertyLinkOID,
    LinkType,
    ExactlyOne,
    toProps(
      ...
      Details(
        """This link is sometimes necessary when you have a User Value Property that is a Model Type.
  ...
  lazy val UVUserProp = new SystemProperty(
    UVUserPropOID,
    IdentityAccess.IdentityType,
    ExactlyOne,
    toProps(
  ...
  lazy val UVThingProp = new SystemProperty(
    UVThingPropOID,
    LinkType,
    ExactlyOne,
    toProps(
  ...
  lazy val UVValProp = new SystemProperty(
    UVValPropOID,
  ...
  lazy val UVPropProp = new SystemProperty(
    UVPropPropOID,
    LinkType,
    ExactlyOne,
    toProps(
