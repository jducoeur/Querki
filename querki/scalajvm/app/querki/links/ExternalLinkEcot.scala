...
class ExternalLinkEcot(e: Ecology)
  ...
  lazy val ExternalLinkModel = ThingState(
    ExternalLinkModelOID,
    systemOID,
    RootOID,
    toProps(
  ...
  lazy val ExternalLinkType = new ModelType(
    ExternalLinkTypeOID,
    ExternalLinkModelOID,
    toProps(
    ...
    override def doWikify(
      ...
      displayRawOpt: Option[Wikitext] = None,
      ...
      Future.successful(displayOpt.orElse(displayNameOpt).orElse(urlOpt).map(display =>
        Wikitext("[" + display + "](" + urlOpt.getOrElse("#") + ")")
      ).getOrElse(Wikitext.empty))
    }
  }
  ...
  lazy val ExternalLinkUrlProp = new SystemProperty(
    ExternalLinkUrlOID,
    Links.URLType,
    ExactlyOne,
    toProps(
  ...
  lazy val WithParamFunction = new InternalMethod(
    WithParamFunctionOID,
    toProps(
      setName("_withParam"),
      Categories(LinksTag),
  ...
  lazy val OIDLinkFunction = new InternalMethod(
    OIDLinkOID,
    toProps(
      setName("_oidLink"),
  ...
  lazy val NavigateTo = new InternalMethod(
    NavigateToOID,
    toProps(
      setName("_navigateTo"),
      SkillLevel(SkillLevelAdvanced),
