 ...
 */
case class SearchResultElementInternal(prop:AnyProp, text:String, score:Double, positions:List[Int])
 ...
 */
case class SearchResultInternal(thing:Thing, score:Double, elements:List[SearchResultElementInternal])
