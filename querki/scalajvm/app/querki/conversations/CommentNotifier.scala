...
class CommentNotifierEcot(e: Ecology) extends QuerkiEcot(e) with Notifier with NotifyComments {
  ...
  def notifyComment(
    ...
    implicit val rc = RequestContext(
      Some(req),
      state.ownerIdentity.map(_.id).getOrElse(UnknownOID),
      Some(state.id.toThingId.toString),
      None
    )
  ...
  lazy val CommentThingName = new SystemProperty(
    CommentThingNameOID,
    PlainTextType,
    ExactlyOne,
    toProps(
  ...
  lazy val CommentBody = new SystemProperty(
    CommentBodyOID,
    PlainTextType,
    ExactlyOne,
    toProps(
  ...
  lazy val CommentId = new SystemProperty(
    CommentIdOID,
    IntType,
    ExactlyOne,
    toProps(
  ...
  lazy val CommentSpaceOwner = new SystemProperty(
    CommentSpaceOwnerOID,
    LinkType,
    ExactlyOne,
    toProps(
  ...
  lazy val GetCommentNotesPref = new SystemProperty(
    GetCommentNotesOID,
    YesNoType,
    Optional,
    toProps(
