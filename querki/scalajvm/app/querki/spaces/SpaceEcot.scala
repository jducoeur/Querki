...
class SpaceEcot(e: Ecology) extends QuerkiEcot(e) with SpaceOps with querki.core.MethodDefs {
  ...
  override def createActors(createActorCb: CreateActorFunc): Unit = {
    _region = SystemManagement.createShardRegion("Space", SpaceRouter.actorProps(ecology), idExtractor, shardResolver)
  ...
  lazy val ChangeProperties = new InternalMethod(
    ChangePropertiesOID,
    toProps(
  ...
  lazy val CreateThingFunction = new InternalMethod(
    CreateThingFunctionOID,
    toProps(
  ...
  lazy val CopyThingFunction = new InternalMethod(
    CopyThingFunctionOID,
    toProps(
      setName("_copyThing"),
      Categories(querki.datamodel.DataModelTag),
      SkillLevel(SkillLevelAdvanced),
  ...
  lazy val DeleteThingFunction = new InternalMethod(
    DeleteThingFunctionOID,
    toProps(
      ...
      Signature(
        ...
        returns = (
          AnyType,
          "Not a useful value. It is usually recommended to call `navigateTo` on a specific Thing after this."
        )
      ),
  ...
  lazy val MakePropertyBundleFunction = new InternalMethod(
    MakePropertyBundleFunctionOID,
    toProps(
  ...
  lazy val CreateHere = new InternalMethod(
    CreateHereOID,
    toProps(
      setName("_createHere"),
      Categories(querki.datamodel.DataModelTag),
