 ...
 * 
 * TODO: this code is basically dead. Is there any reason to keep it around any longer?
 */
//class Space(val ecology:Ecology, persistenceFactory:SpacePersistenceFactory, stateRouter:ActorRef, id:OID) 
//  extends Actor with Stash with Requester with EcologyMember with ModelTypeDefiner with SpaceAPI[RequestM]
//{
//  import Space._
//  
...
//   */
//  val pluginReceive = SpaceChangeManager.spacePluginProviders.map(_.createPlugin(this, RealRTCAble).receive).reduce(_ orElse _)
//  
//  /**
