...
class PhotoEcot(e: Ecology)
  ...
  lazy val ImageHeightProp = new SystemProperty(
    ImageHeightOID,
    IntType,
    Optional,
    toProps(
  ...
  lazy val ImageWidthProp = new SystemProperty(
    ImageWidthOID,
    IntType,
    Optional,
    toProps(
  ...
  lazy val ImageMIMETypeProp = new SystemProperty(
    ImageMIMETypeOID,
    Basic.PlainTextType,
    Optional,
    toProps(
  ...
  lazy val ImageFilenameProp = new SystemProperty(
    ImageFilenameOID,
    Basic.PlainTextType,
    Optional,
    toProps(
  ...
  lazy val ImageTimestampProp = new SystemProperty(
    ImageTimestampOID,
    Time.QDateTime,
    Optional,
    toProps(
  ...
  lazy val ImageSizeProp = new SystemProperty(
    ImageSizeOID,
    IntType,
    Optional,
    toProps(
  ...
  lazy val ImageThumbnailFilenameProp = new SystemProperty(
    ImageThumbnailFilenameOID,
    Basic.PlainTextType,
    Optional,
    toProps(
  ...
  lazy val ImageThumbnailHeightProp = new SystemProperty(
    ImageThumbnailHeightOID,
    IntType,
    Optional,
    toProps(
  ...
  lazy val ImageThumbnailWidthProp = new SystemProperty(
    ImageThumbnailWidthOID,
    IntType,
    Optional,
    toProps(
  ...
  lazy val PreferredImageSizeProp = new SystemProperty(
    PreferredImageSizeOID,
    IntType,
    Optional,
    toProps(
      ...
      Details(
        """Querki is designed for "web resolution" photographs -- that is, photos should fit on a webpage.
  ...
  lazy val ImageCaptionProp = new SystemProperty(
    ImageCaptionOID,
    RQL.ParsedTextType,
    Optional,
    toProps(
  ...
  lazy val ThumbnailFunction = new InternalMethod(
    ThumbnailFuncOID,
    toProps(
      setName("_thumbnail"),
      Categories(PhotosTag),
  ...
  lazy val PhotoTargetFunction = new InternalMethod(
    PhotoTargetFuncOID,
    toProps(
  ...
  lazy val PhotoModel = ThingState(
    PhotoModelOID,
    systemOID,
    RootOID,
    toProps(
  ...
  lazy val PhotoType = new ModelType(
    PhotoTypeOID,
    PhotoModelOID,
    toProps(
      setName("Photo Type"),
      ...
      Categories(PhotosTag),
      Summary("A single Photograph in Querki")
    )
  ) with FullInputRendering {

    override def doWikify(
      context: QLContext
    )(
      v: ModeledPropertyBundle,
      ...
      val result = for {
        ...
        image = HtmlWikitext(
          s"""<img class="img-responsive center-block" src="$bucketUrl/${filename.raw}" alt="${filename.raw}" />"""
        )
    ...
    override def doComp(
      ...
      left: ModeledPropertyBundle,
      right: ModeledPropertyBundle
    ): Boolean = {
  ...
  def fromPropStr(context: QLContext) =
    context.fromPropertyOfType(PhotoType).map(prop => s""" data-fromprop="${prop.id.toString}" """).getOrElse("")
