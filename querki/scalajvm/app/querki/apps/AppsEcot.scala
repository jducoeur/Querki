...
class AppsEcot(e: Ecology) extends QuerkiEcot(e) with querki.core.MethodDefs with SpacePluginProvider with Apps {
  ...
  def getShadowedThing(t: Thing)(implicit state: SpaceState): Thing = {
    if (t.ifSet(ShadowFlag)) {
      val model = state.anything(t.model).getOrElse(
        throw new Exception(s"Shadow ${t.displayName} calls for Model ${t.model}, but we can't find it!")
      )
  ...
  lazy val ShadowedThingFunction = new InternalMethod(
    ShadowedThingOID,
    toProps(
  ...
  lazy val CanUseAsAppPerm = AccessControl.definePermission(
    CanBeAppOID,
  ...
  lazy val CanManipulateAppsPerm = AccessControl.definePermission(
    CanManipulateAppsOID,
  ...
  lazy val ShadowFlag = new SystemProperty(
    ShadowFlagOID,
    YesNoType,
    ExactlyOne,
    toProps(
  ...
  lazy val GallerySummary = new SystemProperty(
    GallerySummaryOID,
    PlainTextType,
    ExactlyOne,
    toProps(
  ...
  lazy val GalleryDetails = new SystemProperty(
    GalleryDetailsOID,
    PlainTextType,
    ExactlyOne,
    toProps(
  ...
  lazy val GalleryOwner = new SystemProperty(
    GalleryOwnerOID,
    LinkType,
    ExactlyOne,
    toProps(
  ...
  lazy val GalleryAppId = new SystemProperty(
    GalleryAppIdOID,
    LinkType,
    ExactlyOne,
    toProps(
  ...
  lazy val GalleryEntryId = new SystemProperty(
    GalleryEntryOID,
    LinkType,
    ExactlyOne,
    toProps(
  ...
  lazy val IsAppFlag = new SystemProperty(
    IsAppOID,
    YesNoType,
    Optional,
    toProps(
  ...
  lazy val GalleryEntryModel = ThingState(
    GalleryEntryModelOID,
    systemOID,
    Basic.SimpleThing,
    toProps(
