...
case class ContainedPropPath[VT](
  container: Property[ModeledPropertyBundle, _],
  path: PropPath[VT, _]
) extends PropPath[VT, ModeledPropertyBundle] {
...
class PropPathEcot(e: Ecology) extends QuerkiEcot(e) with PropPaths {
   ...
   */
  def modelPropertiesWithPath[VT](
    allModelTypes: Iterable[ModelTypeBase],
    wrapping: PropPath[VT, _]
  )(implicit
    state: SpaceState
  ): Iterable[PropPath[VT, ModeledPropertyBundle]] = {
