...
class TypesModule(e: Ecology) extends QuerkiEcot(e) with Types with ModelTypeDefiner with EcologyMember {
   ...
   */
  class WrappedValueType(tid: OID)
    extends SystemType[QValue](
      tid,
      toProps(
    ...
    def doDeserialize(v: String)(implicit state: SpaceState) = {
      throw new Exception("WrappedValueType does not implement doDeserialize")
    }

    def doSerialize(v: QValue)(implicit state: SpaceState) = {
      throw new Exception("WrappedValueType does not implement doSerialize")
    }
   ...
   */
  private def getChildBundle(
    existingOpt: Option[PropertyBundle],
    mt: ModelTypeDefiner#ModelType,
    modelProp: Property[ModeledPropertyBundle, _],
    indexOpt: Option[Int]
  )(implicit
    state: SpaceState
  ): Option[PropertyBundle] = {
    for {
   ...
   */
  private def replaceChildBundle(
    existingOpt: Option[PropertyBundle],
    childBundle: ElemValue,
    modelProp: Property[ModeledPropertyBundle, _],
    indexOpt: Option[Int]
  )(implicit
    state: SpaceState
  ...
  def rebuildBundle(
    existingOpt: Option[PropertyBundle],
    containers: List[IndexedOID],
    innerV: FormFieldInfo
  )(implicit
    state: SpaceState
  ...
  lazy val ModelForTypeProp = new SystemProperty(
    ModelForTypePropOID,
    LinkType,
    ExactlyOne,
    toProps(
  ...
  lazy val MinTextLengthProp = new SystemProperty(
    MinTextLengthOID,
    IntType,
    ExactlyOne,
    toProps(
  ...
  lazy val MinIntValueProp = new SystemProperty(
    MinIntValueOID,
    IntType,
    ExactlyOne,
    toProps(
  ...
  lazy val MaxIntValueProp = new SystemProperty(
    MaxIntValueOID,
    IntType,
    ExactlyOne,
    toProps(
  ...
  lazy val DefaultValueProp = new SystemProperty(
    DefaultValuePropOID,
    WrappedValueType,
    ExactlyOne,
    toProps(
  ...
  lazy val AppliesToTypesProp = new SystemProperty(
    AppliesToTypesPropOID,
    LinkType,
    QSet,
    toProps(
  ...
  object TypeFunctions extends QuerkiEcot(e) with querki.core.MethodDefs {
    ...
    lazy val WithPropertyFunction = new InternalMethod(
      WithPropertyOID,
      toProps(
