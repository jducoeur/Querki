...
class ChoiceEcot(e:Ecology) extends QuerkiEcot(e) with Choices {
  ...
  lazy val ChooseFromPropProp = new SystemProperty(ChooseFromPropertyOID, LinkType, Optional,
    toProps(
  ...
  lazy val ChooseFromThingProp = new SystemProperty(ChooseFromThingOID, LinkType, Optional,
    toProps(
