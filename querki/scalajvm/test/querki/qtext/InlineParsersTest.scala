...
class InlineParsersTest extends FlatSpec with Matchers with InlineParsers with InlineBase {
  ...
  val linkTests = List(
    (
      ...
      """<a href="http://example.com" title="link title" rel="nofollow" target="_blank">link text</a>"""
    ),
    (
      """[link text](http://example.com )""",
      """<a href="http://example.com" rel="nofollow" target="_blank">link text</a>"""
    ),
    (
      """[link text](  http://example.com  "link title"  )""",
      """<a href="http://example.com" title="link title" rel="nofollow" target="_blank">link text</a>"""
    ...
    (
      ...
      """<a href="http://example.com" title="li)nk&quot; title" rel="nofollow" target="_blank">link text</a>"""
    ),
    ("""[_localName](_localName)""", """<a href="_localName">_localName</a>""")
  )
//
...
//    )
  ...
  val imageTests = List(
    ("""![alt text](/src/img.png "img title")""", """<img src="/src/img.png" alt="alt text" title="img title" />"""),
    ("""![alt text](/src/img.png )""", """<img src="/src/img.png" alt="alt text" />"""),
    (
  ...
  val allInlineTests =
    italicTests ++ boldTests ++ codeTests ++ linkTests ++ /* fastLinkTests ++*/ imageTests ++ brTests ++
...
//    }
  ...
  it should "resolve reference links" in {
    ...
    apply(p, "[text][id]") should equal(
      """<a href="http://www.example.com" title="Title" rel="nofollow" target="_blank">text</a>"""
    )
    apply(p, "[text] [id]") should equal(
      """<a href="http://www.example.com" title="Title" rel="nofollow" target="_blank">text</a>"""
    )
    apply(p, "[id][]") should equal(
      """<a href="http://www.example.com" title="Title" rel="nofollow" target="_blank">id</a>"""
    )
    apply(p, "[id] []") should equal(
      """<a href="http://www.example.com" title="Title" rel="nofollow" target="_blank">id</a>"""
    )
    ...
    apply(p, "[id] [Id 2]") should equal(
      """<a href="http://other.example.com" title="Title 2" rel="nofollow" target="_blank">id</a>"""
    )
    apply(p, "[id 3]") should equal("""<a href="http://none.example.com" rel="nofollow" target="_blank">id 3</a>""")
    apply(p, "[foo \"bar\"][id 3]") should equal(
      """<a href="http://none.example.com" rel="nofollow" target="_blank">foo &quot;bar&quot;</a>"""
    )
  }
