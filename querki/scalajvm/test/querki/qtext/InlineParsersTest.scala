...
//    }
    ...
    it should "resolve reference links" in {
        val p  = inline(map)
        apply(p, "[text][id]")  should equal ("""<a href="http://www.example.com" title="Title" rel="nofollow" target="_blank">text</a>""")
        apply(p, "[text] [id]") should equal ("""<a href="http://www.example.com" title="Title" rel="nofollow" target="_blank">text</a>""")
        apply(p, "[id][]")      should equal ("""<a href="http://www.example.com" title="Title" rel="nofollow" target="_blank">id</a>""")
        apply(p, "[id] []")     should equal ("""<a href="http://www.example.com" title="Title" rel="nofollow" target="_blank">id</a>""")
        apply(p, "[id]")        should equal ("""<a href="http://www.example.com" title="Title" rel="nofollow" target="_blank">id</a>""")
        apply(p, "[Id]")        should equal ("""<a href="http://www.example.com" title="Title" rel="nofollow" target="_blank">Id</a>""")

        apply(p, "[id] [Id 2]")        should equal ("""<a href="http://other.example.com" title="Title 2" rel="nofollow" target="_blank">id</a>""")
        apply(p, "[id 3]")             should equal ("""<a href="http://none.example.com" rel="nofollow" target="_blank">id 3</a>""")
        apply(p, "[foo \"bar\"][id 3]")             should equal ("""<a href="http://none.example.com" rel="nofollow" target="_blank">foo &quot;bar&quot;</a>""")
    }
