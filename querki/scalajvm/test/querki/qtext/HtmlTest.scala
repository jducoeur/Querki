...
<p>Foo foo</p>
  ...
  "Legal class attributes" should {
    "parse cleanly" in {
      apply("""Hello <div class="class-1 class_2">there</div>""") should equal(
        """<p>Hello <div class="class-1 class_2">there</div></p>
        |""".stripReturns
      )
      apply("""Hello <span class="class-1 class_2">there</span>""") should equal(
        """<p>Hello <span class="class-1 class_2">there</span></p>
        |""".stripReturns
      )
    }
  }
  ...
  "Data attributes" should {
    "parse if single-valued" in {
      apply("""Hello <div data-thingy="firstValue">there</div>""") should equal(
        """<p>Hello <div data-thingy="firstValue">there</div></p>
        |""".stripReturns
      )
    }
    "parse if multi-valued" in {
      apply("""Hello <div data-thingy="firstValue,secondValue">there</div>""") should equal(
        """<p>Hello <div data-thingy="firstValue,secondValue">there</div></p>
        |""".stripReturns
      )
    }
    ...
    "be escaped on bad name" in {
      apply("""Hello <div data-foo!="something">there</div>""") should equal(
        """<p>Hello &lt;div data-foo!=&quot;something&quot;&gt;there</div></p>
        |""".stripReturns
      )
    }
  }
  ...
  "Illegal attributes" should {
    "be escaped and passed through" in {
      apply("""Hello <div style="something">there</div>""") should equal(
        """<p>Hello &lt;div style=&quot;something&quot;&gt;there</div></p>
        |""".stripReturns
      )
    }
  }
  ...
  "Illegal attribute values" should {
    "be caught" in {
      apply("""Hello <div class="javascript:stuff">there</div>""") should equal(
        """<p>Hello <div class="ILLEGAL ATTRIBUTE">there</div></p>
        |""".stripReturns
      )
    }
  }
