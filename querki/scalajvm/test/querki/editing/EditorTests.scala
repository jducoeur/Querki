  ...
  "_edit" should {
    ...
    "enable me to edit a simple Thing" in {
      ...
      processQText(commonThingAsContext(_.trivialThing), """[[_edit]]""") should
        include (s"""<input value="" type="text" class="_textEdit form-control propEditor" name="v-q-$trivialOID" data-prop=".q" data-propId="q" id="v-q-$trivialOID" data-thing="$trivialThingId" />""")      
    }
  }
}
