  ...
  "A Function" should {
    "be able to resolve using lexical context" in {
      ...
      class TSpace extends CommonSpace {
        ...
        val callingThing =
          new SimpleTestThing("Caller", myFunc("My Number"), outerText("From the outside: [[Other -> My Function]]"))
    ...
    "be able to resolve using an instance's lexical context" in {
      ...
      class TSpace extends CommonSpace {
        ...
        val callingThing =
          new TestThing("Caller", callingModel, outerText("From the outside: [[Other -> My Function]]"))
        val otherThing = new SimpleTestThing("Other", myNumber(42), otherNumber(13))
      }
      implicit val s = new TSpace
    ...
    "resolve using the received context if there is no lexical one" in {
      ...
      class TSpace extends CommonSpace {
        ...
        val callingThing =
          new SimpleTestThing("Caller", outerText("From the outside: [[Other -> My Function]]"))
        val otherThing = new SimpleTestThing("Other", myNumber(42), myFunc("Other Number"), otherNumber(13))
      }
      implicit val s = new TSpace
    ...
    "resolve using the defining context if there is no lexical one" in {
      ...
      class TSpace extends CommonSpace {
        ...
        val callingThing =
          new SimpleTestThing("Caller", outerText("From the outside: [[Other -> External Thing.My Function]]"))
        val otherThing = new SimpleTestThing("Other", myNumber(42), myFunc("Other Number"), otherNumber(13))
